...
import '../../domain/repository_contract/recommended_for_you_repo.dart' as _i7;
import '../../domain/usecases/best_selling_usecase.dart' as _i5;
import '../../domain/usecases/new_arrival_usecase.dart' as _i12;
import '../../domain/usecases/recommended_usecase.dart' as _i6;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i6.RecommendedUseCase>(
        () => _i6.RecommendedUseCase(gh<_i7.RecommendedForYouRepo>()));
    ...
    gh.factory<_i11.RecommendedCubit>(
        () => _i11.RecommendedCubit(gh<_i6.RecommendedUseCase>()));
    gh.factory<_i12.NewArrivalUseCase>(
        () => _i12.NewArrivalUseCase(gh<_i8.NewArrivalRepo>()));
    gh.factory<_i13.NewArrivalCubit>(
        () => _i13.NewArrivalCubit(gh<_i12.NewArrivalUseCase>()));
    return this;
  }
}
